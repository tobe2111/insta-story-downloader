...
> · **통합 분산 계좌**(`run_daily_portfolio`, 8마일 챌린지) — 실제로 돈이
>   도는 쪽. **게이트가 걸립니다.**
...
## 8마일 챌린지 — 8만원 → 1억 (후원 매칭 입금)

통합 가상 계좌가 **8만원(8종목 × 만원, 영화 8 Mile 오마주)**으로 시작해 1억을
향해 갑니다. 개별 종목 계좌는 각자 만원으로 참고용 기록을 따로 쌓습니다.
...
### 8마일 챌린지 실거래 전환 절차 (하루 1회 집행 — 준비 완료 상태)
